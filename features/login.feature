Feature: Autenticación de Usuarios en Sauce Labs
  ...
  # Background que abra la página de login
  Background: Abrir la página de autenticación
    Given estoy en la página de login

  # Escenario exitoso con credenciales válidas (standard_user / secret_sauce)
  @smoke @ui
  ...
  # Scenario Outline con al menos 3 casos de error
  @regression @error @ui
